...
- **Faz 4B/C/D — Kütüphane + Learn + Obsidian:** (4B) Boards/ContentItem birleşik + capture/search/board bütünlüğü; (4C) Learn UI + NotebookLM/manuel transcript → Pack → atomik not/zihin haritası/task/review; (4D) Obsidian GitHub/local export uçtan uca canlı doğrulama + ABSORBED ekran emekliliği (compatibility kanıtı). Mevcut Learn/Obsidian/Boards altyapısı yeniden İCAT EDİLMEZ.
