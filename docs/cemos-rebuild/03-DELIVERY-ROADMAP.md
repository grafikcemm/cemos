...
- **Faz 2 — Hafıza + agent orchestration** (dilim haritası + envanter: `07-PHASE2-PLAN.md`):
  ...
  - **2E (sonra):** eval/observability kapanışı + canlı kürasyon aktivasyonu (OpenRouter kredisi mevcut — kullanıcı onayı bekliyor) + thread eşik kalibrasyonunun gerçek etiketli veriyle tamamlanması.
