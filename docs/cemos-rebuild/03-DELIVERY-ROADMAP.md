...
- **Faz 2 — Hafıza + agent orchestration** (dilim haritası + envanter: `07-PHASE2-PLAN.md`):
  ...
  - **2C–2E (sonra):** dinamik hesap kaynağı (2C — turnkey harita `07-PHASE2-PLAN.md`) · thread üretim hattı + backfill + kalibrasyon (2D) · eval/observability kapanışı + canlı kürasyon aktivasyonu (2E; OpenRouter kredisi mevcut — kullanıcı onayı bekliyor).
