> **⚠ ADR-020 override (2026-07-15, kullanıcı kararı).** CemOS **desktop-only + tek tema dark editorial** (light kararı supersede). Bu belgedeki TÜM "1280/390" → **"1024/1280/1440/1920 desktop screenshot"**; "320-1440 taşma yok" → **"1024–1920 taşma yok"**; mobil = best-effort (390 screenshot/mobil-özel component üretilmez, MobileNav compat korunur). Renkler dark. Faz 1C–1F UI yalnız desktop tasarlanır (drawer=side panel, segment editor desktop, 1024'te kullanılabilir).
>
