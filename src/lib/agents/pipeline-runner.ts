 ...
 * changing any chain's control flow. runStage wraps generateJson 1:1 — same
 * args, same return value — and additionally times the call and records a trace
 * entry. flush writes the accumulated trace best-effort (it NEVER throws, so a
