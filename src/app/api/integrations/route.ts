...
export async function GET(req: NextRequest) {
  ...
  const providers: Provider[] = [
    ...
    {
      key: "obsidian_local",
      name: "Obsidian · Yerel vault",
      group: "optional",
      status: has("OBSIDIAN_VAULT_PATH") ? "connected" : "optional",
      envNames: ["OBSIDIAN_VAULT_PATH"],
      note: "Öğrenme paketi yerel Obsidian vault'a yazılır (Node fs). Vercel/serverless'te dosya sistemi KALICI DEĞİL — yalnız yerel çalıştırmada anlamlı. Son export durumu paketin export panelinde.",
    },
    {
      key: "obsidian_github",
      name: "Obsidian · GitHub vault",
      group: "optional",
      status: has("OBSIDIAN_GITHUB_TOKEN", "GITHUB_PERSONAL_ACCESS_TOKEN") ? "connected" : "optional",
      envNames: ["OBSIDIAN_GITHUB_REPO", "OBSIDIAN_GITHUB_TOKEN"],
      note: "Öğrenme paketi bir GitHub vault reposuna commit'lenir; Obsidian Git eklentisi repoyu çeker (Vercel'de kalıcı export yolu). Yalnız hazır paket; idempotent (değişmemiş dosya commit üretmez).",
    },
    {
      key: "gemini",
      name: "Gemini",
