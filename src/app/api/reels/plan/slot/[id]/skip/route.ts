...
/**
 * Slot atla/skip (ADR-039 §8) — non-destructive status="skipped". Dossier/handoff
 * FİZİKSEL silinmez; done atlanamaz; idempotent (alreadySkipped); optimistic
 * concurrency.
 */
